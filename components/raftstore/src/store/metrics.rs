...
lazy_static! {
    ...
    pub static ref LOAD_BASE_SPLIT_TOP_REGION_VEC: HistogramVec = register_histogram_vec!(
        "tikv_load_base_split_top_region",
        "Histogram of top region load observed by load base split on this TiKV.",
        &["type"],
        exponential_buckets(1.0, 2.0, 26).unwrap()
    ).unwrap();
